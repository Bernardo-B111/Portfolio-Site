...
const socialLinks = [
  {
    href: 'https://github.com/Bernardo-B111',
  ...
  {
    href: 'https://www.linkedin.com/in/bernardo-barragan-a09016282/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.kaggle.com/bernardobarra',
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.5 3H8.5V10.5L14.25 3H19.75L12.95 11.55L20.2 21H14.8L9.9 14.4L8.5 16.2V21H4.5V3Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    </svg>,
    alt: 'Kaggle'
  },
  {
    href: 'https://x.com/qhpmas',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Reach out today to discuss potential offers or simply talk about the vast world of data!
          </p>
        ...
        <form
          action="https://getform.io/f/aejrzlwb"
          method="POST"
